...
export class NotificationService {
  ...
  showSuccess(
    message: string = this.translate.instant('general.success-message'),
    title: string = this.translate.instant('general.success')
  ) {
  ...
  showInfo() {
    this.toastr.info(
      this.translate.instant('validation.informational-message'),
      this.translate.instant('validation.info')
    );
  }
